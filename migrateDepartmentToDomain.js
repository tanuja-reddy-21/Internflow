/**
 * Migration Script: Department → Domain
 * 
 * This script migrates existing database records from "department" field to "domain" field.
 * Run this ONCE after deploying the code changes.
 * 
 * Usage: node migrations/migrateDepartmentToDomain.js
 */

const mongoose = require('mongoose');
require('dotenv').config();

// Domain mapping: Old department values → New domain values
